...
# -*- coding: utf8 -*-
"""
Module defining BigInvestmentTrader agent class.
"""
...
from fms.utils.priceQuantityTracker import priceList, quantityList, bestBuyOffers, bestSellOffers


class BigInvestmentTrader(agents.Agent):
    """
    ...
    exception is raised.
    >>> from fms.agents import biginvestmenttrader
    >>> params = {'agents': [{'money':10000, 'stocks':200}]}
    >>> agent = biginvestmenttrader.BigInvestmentTrader(params)
